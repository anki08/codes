/*    Operating Systel Laboratory Assignment -4 */               
*
*      Date            : 22nd March 2011
*
*      08/CSE/19       : Abhimanyu Srivastava
*      08/CSE/21       : Naimuddin Shek
*    
*      email-id        : md.naimuddin.shekh@gmail.com
*       
*
*
*
...
int main()
{
	...
	char *str1[ARGVSIZE];                       //This stores argumne/command which appear before | .
	char *str2[ARGVSIZE];                       //This store filters give after |.
	for(;;)
	{
		n=1;
		write(STDOUT_FILENO,"[Enter command]% ",17);
		read(STDIN_FILENO,buf,BUFSIZE+1);                    //Read command in to buffer
		if(!strcmp(buf,"exit\n")) exit(1);
