...
7-10th bit. Choose one of the alternatives for the following
...
in file 2.c then they must be declared in file 1.c as 
	a. auto  b. global c. static d. external
...
20. struct out {
	...
	Which is incorrect?
	1. a1.p1->c  2. pa1->p1->c  3. a1->p1  4.a1.s1.c
...
30. Write an expressionfor " either x lies in the range of 10 to 5o or y =
0"
...
32. Choose the incorrect one
	...
	a. global b. local  c. its type must be declared before using 
	d. -----


33. The delimitor for statements is 
	1, semicolon b. colon c. --   d.---

34. which of the following is invalid?
	a. int a;  b. int c = 10;  c. float a int b = 3.5  d.---------
...
40. HOw many times will the while loop be xecuted?
	a = 0;
	while(a<5);
	a++:
...
42. among the following which one will come out of loop when exp2 becomes
false
	a. ---
